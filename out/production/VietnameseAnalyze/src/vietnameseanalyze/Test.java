...
//        var parser=VietnameseAnalyze.decideParser(jg);
...
//        var betterTree=VietnameseAnalyze.findABetterType(maxTree);
        ...
        var res = VietnameseAnalyze.decideParser(wordInfos);
